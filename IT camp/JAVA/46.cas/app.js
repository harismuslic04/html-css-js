...
// 1. iz 2 poslata niza vratiti 3. koji sadrzi elemente koji jedan ima a drugi ne
...
function zadatak(arr) {
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].quantity > 40) {
      arr[i].price *= 0.6;
    } else if (arr[i].quantity > 20) {
      arr[i].price *= 0.8;
    }
  }
  return arr;
